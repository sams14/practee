module.exports = (mentorName, pipFormLink) => {
  const mailHTML =
    `<!DOCTYPE html>
    ...
    mentorName +
    `&nbsp;<span style="color: #000101;">!</span></span></strong></h1>
                                  </td>
                                </tr>
                              </table>
                                  ...
                                  <td class="pad">
                                    <div style="font-family: sans-serif">
                                      <div class style="font-size: 14px; mso-line-height-alt: 21px; color: #6f7077; line-height: 1.5; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                        <p style="margin: 0; mso-line-height-alt: 21px;">Your PIP duration has been extended by your auditor. Please review your PIP details by clicking on the button below.</p>
                                        <p style="margin: 0; mso-line-height-alt: 21px;">&nbsp;</p>
                                        <p style="margin: 0; mso-line-height-alt: 21px;"><strong>Regards,&nbsp;</strong></p>
                                        <p style="margin: 0; mso-line-height-alt: 21px;"><strong>Team Practee </strong></p>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
                              ...
                              <table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                <tr>
                                  <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;padding-top:5px;padding-bottom:5px;">
                                    <div class="alignment" align="center" style="line-height:10px"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4091/image-host.png" style="display: block; height: auto; border: 0; width: 350px; max-width: 100%;" width="350" alt="Services Company" title="Services Company"></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
